...
<body>
    ...
    ?>
		...
		<tr>
			...
			<table align="center" border="0" cellpadding="1" cellspacing="1" width="80%" style="border-collapse: collapse;">
				...
				<tr>			    
				    ...
				    <td width="30%" style="text-align: center;" class="datosp">
					<strong>Fecha L&iacute;mite:<?php //echo "--".$sql2 ?></strong>
				    </td>				    
				</tr>
				<tr>
					<?php
		...
		<?php
			...
			echo "<tr><td align=\"center\" bgcolor=\"#FFFFFF\" colspan=\"5\"><div class=\"datosc\"><B>Estado de Solicitud:</B></div></td></tr><tr><td align=\"center\" bgcolor=\"#FFFFFF\"><div class=\"datosc\">".$stat["estatus"]."</div></td></tr>";

			if ($tab["id_estatus"] == '2'){
				$sql2="SELECT observacion FROM sol_tgpp WHERE exp_e='".$reg["EXP_E"]."' AND TIPO_PASANTIA='2'";
				$conex1 -> ExecSQL($sql2,__LINE__,true);
				$obs = $conex1->result[0][0];

				if (!empty($obs)){
		?>
				<tr><td align="center">
				<label for="obs" id="lobs" style="font-size:13px;">Observacion:</label>
				<textarea name="obs" id="obs" cols="50" readonly><?php echo $obs; ?></textarea>
				</td></tr>
		<?php
				}
			}
				...
				if ($tab["id_estatus"] == '3') {// Si esta aprobado
					...
					$mSQL.= "FROM sol_tgpp ";
					$mSQL.= "WHERE CI_E='".$_SESSION["cedula"]."' AND TIPO_PASANTIA='2' ";
					...
					if (!empty($ta)){
						...
						echo "<hr><table border=0 style=\"font-family:Arial;font-size:11px;\" width=\"100%\"><tr>";						
						echo "<td width=\"25%\"><center>Carta Tutor Academico<br><a href=\"carta_tutor_a.php?id=".$_SESSION["cedula"]."&tp=2\" target=\"_blank\"><img src=\"imagenes/impresora02.gif\" alt=\"imprimir\" width=\"40\" height=\"40\" border=\"0\"></a></center></td>";

						if (!empty($jc)){
							echo "<td width=\"25%\"><center>Carta Jurado Coordinador<br><a href=\"carta_jurado_c.php?id=".$_SESSION["cedula"]."&tp=2\" target=\"_blank\"><img src=\"imagenes/impresora02.gif\" alt=\"imprimir\" width=\"40\" height=\"40\" border=\"0\"></a></center></td>";
							echo "<td width=\"25%\"><center>Carta Jurado Secretario<br><a href=\"carta_jurado_s.php?id=".$_SESSION["cedula"]."&tp=2\" target=\"_blank\"><img src=\"imagenes/impresora02.gif\" alt=\"imprimir\" width=\"40\" height=\"40\" border=\"0\"></a></center></td>";

							$t_acta = ($reg[C_UNI_CA] == 5) ? "tg" : "pp";

							echo "<td width=\"25%\"><center>Acta Evaluacion Final<br><a href=\"acta_final_".$t_acta.".php?id=".$_SESSION["cedula"]."&tp=2\" target=\"_blank\"><img src=\"imagenes/impresora02.gif\" alt=\"imprimir\" width=\"40\" height=\"40\" border=\"0\"></a></center></td>";					
						}
						echo "</tr></table><hr>";
						echo "</td></tr>";
					}
...
//		if($reg['C_UNI_CA']!=5 && $tab['TIPO_PASANTIA']==2)
		...
		<?php
		    ...
		    }// fin tiene jurado coordinador
				}// fin tiene trabajo registrado
		}//fin encuentra datos estudiante
		?>
		<tr><td colspan="5" style="background-color:#99CCFF;"><font style="font-size:2px;">&nbsp;</font></td></tr>
		<tr><td colspan="5"><font style="font-size:5px;">&nbsp;</font></td></tr>		
		<tr align=center>
