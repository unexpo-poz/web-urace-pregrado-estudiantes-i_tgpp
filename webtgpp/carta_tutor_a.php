...
$pdf->ezSetCmMargins(2.5,2.5,2.5,2.5);
	$sql2="select CI_E, TIPO_PASANTIA, empresa, n_proyecto, cedula_TI, nombre_TI, apellido_TI, id_estatus, cedula_TA from sol_tgpp where CI_E='$_REQUEST[id]' and TIPO_PASANTIA='$_REQUEST[tp]' ";
...
$pdf->ezSetY(440);
$pdf->ezText('SIRVA LA PRESENTE PARA INFORMARLE FORMALMENTE QUE HA SIDO DESIGNADO <b>TUTOR ACADÉMICO</b> DE'.$ART[0]["ART"].' '.
