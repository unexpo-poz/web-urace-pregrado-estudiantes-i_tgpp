...
$pdf->ezSetCmMargins(2.5,2.5,2.5,2.5);
	$sql="select CI_E, empresa, n_proyecto, TIPO_PASANTIA, cedula_TI, nombre_TI, apellido_TI, telefono_TI, correo_TI, fecha_i, fecha_c, id_estatus, cedula_TA, cedula_JC, cedula_JS from sol_tgpp  where CI_E='$_REQUEST[id]' and TIPO_PASANTIA='$_REQUEST[tp]' ";
...
$pdf->ezSetY(440);
$pdf->ezText('SIRVA LA PRESENTE PARA INFORMARLE FORMALMENTE QUE HA SIDO DESIGNADO <b>COORDINADOR DEL JURADO EVALUADOR</b> DE'.$ART[0]["ART"].' '.
