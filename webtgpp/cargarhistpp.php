...
<head>
    ...
    <title>Registro de Proyectos Práctica Profesional</title>
    <script language=javascript>
    function fechaC(){
...
<body>
    ...
    ?>
	<form name="Solicitud" action="histestpp.php" onSubmit="return validar(this)">
		...
		<?php
		    $sql1="select ID_EMPRESA, EXP_E, TIPO_PASANTIA from sol_solicitudes where EXP_E= '$reg[EXP_E]' and TIPO_PASANTIA='1'";
		    $conex -> ExecSQL($sql1,__LINE__,true);
		    $fila = $conex->filas;
		    if ($fila==1)
			{
