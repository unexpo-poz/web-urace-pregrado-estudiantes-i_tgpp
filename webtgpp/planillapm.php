...
<head>
    ...
    <title>Actualizacion de Proyecto - Práctica Profesional</title>
	...
	if ($fila==1)
	{
		...
		//echo $empre['ID_EMPRESA'];
			...
			print (" <script language='javascript'> window.alert('DEBE REGISTRAR SU PRÁCTICA PROFESIONAL EN EL DEPARTAMENTO DE ENTRENAMIENTO INDUSTRIAL');window.close();</script>");
				...
				//echo $empre['ID_EMPRESA'];
    ?>
	<form name="Solicitud" action="modificarpp.php" method="post" onSubmit="return validar(this)">
		...
		<tr>
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
				...
				<tr>
					...
					$tSQL.= "FROM sol_tgpp WHERE ci_e = '$_SESSION[cedula]' AND tipo_pasantia = '1' ";
