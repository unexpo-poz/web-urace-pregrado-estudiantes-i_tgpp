...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/i_tgpp/';
...
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/tgpp/tgpp_'.date(m).'-'.$lapsoProceso.'.log';
...
if ($modoInscripcion == '1'){
	...
	$tProceso	= 'Registro de Trabajo de Grado - Práctica Profesional';
}
...
$mensajeppal = "Disculpe, el sistema est&aacute; en mantenimiento.<br><br>";
